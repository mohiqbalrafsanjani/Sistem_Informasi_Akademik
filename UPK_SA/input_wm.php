...
alert('Data Wali Murid Berhasil Di Simpan');
document.location='index.php?page=12';
</script>";	
			} else {
		echo "<script language=javascript>
alert('Data Wali Murid Gagal Di Simpan');
document.location='index.php?page=12';
</script>";	
	}
}
...
<?php
include "koneksi.php";
$query="SELECT max(kode_wali) as maxkode FROM wali_murid";
$hasil=mysql_query($query);
$data=mysql_fetch_array($hasil);
$kode_wali=$data['maxkode'];
$no=(int) substr($kode_wali, 3,3);
$no++;
$char="WM";
...
<!-- Vendors -->
  ...
  <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">Input Data Wali Murid</h3>
            </div>
...
<p>Kode Wali</p>
<p><input type="text" class="form-control" name="kode_wali" size="25" value="<?php echo"$id"; ?>" readonly="" required ></p>
<p>NISN</p>
<p><p><?php    
    // Koneksi
    ...
    echo '<select name="NISN" id="select01" class="chzn-select"  onchange="document.getElementById(\'nama_siswa\').value = prdName[this.value]" required>';  
    echo '<option></option>';  
    while ($row = mysql_fetch_array($result)) {  
        echo '<option value="' . $row['NISN'] . '">' . $row['nama_siswa'] . '</option>';  
...
<p>Nama Ayah</p>
<p><input type="text" class="form-control" name="nama_ayah" size="25" required ></p>
<p>Pekerjaan Ayah</p>
<p><input type="text" class="form-control" name="pekerjaan_ayah" size="25" required ></p>
<p>Nama Ibu</p>
<p><input type="text" class="form-control" name="nama_ibu" size="25" required ></p>
<p>pekerjaan Ibu</p>
<p><input type="text" class="form-control" name="pekerjaan_ibu" size="25" required ></p>
<p>Alamat Wali</p>
<p><textarea class="form-control" name="alamat_wali" rows="3" required></textarea></p>
<p>No. Telepon Wali</p>
<p><input type="text" class="form-control" name="telp_wali" size="25" required ></p>
<!--<p>Foto Siswa</p>
