...
if (strlen($foto_siswa)>0) {
	...
	//insert ke tabel
	$query = "insert into siswa values('$NISN','$kode_kk','$kode_kelas','$nama_siswa','$alamat_siswa','$tgl_lahir','$foto_siswa')";
...
<p><?php    
    ...
    echo '<select name="kode_kelas" id="select01" class="chzn-select"  onchange="document.getElementById(\'kelas\').value = prdName1[this.value]" required>';  
    echo '<option> </option>';  
...
<p>Nama Siswa</p>
<p><input type="text" class="form-control" name="nama_siswa" size="25" required></p>
<p>Alamat Siswa</p>
<p><textarea class="form-control" name="alamat_siswa" rows="3" required></textarea></p>
<p>Tanggal Lahir</p>
<p><input type="text" class="form-control datepicker" id="date01" name="tgl_lahir" size="25" required></p>
<p>Foto Siswa</p>
<p><input type="file" class="form-control uniform_on" id="fileInput"  name="foto_siswa" ></p>
