...
$kode_kelas=$_GET['kode_kelas'];
 ...
 $query= mysql_query ("select * from siswa where kode_kelas='$kode_kelas'");
...
$kode_sk=$_GET['kode_sk'];
 ...
 $query1= mysql_query ("select * from standar_kompetensi where kode_sk='$kode_sk'");
while($row1=mysql_fetch_array($query1))
			{
			$nama_sk=$row1[nama_sk];
			echo " 
<td>$row1[nama_sk]</td>
</tr>
";
