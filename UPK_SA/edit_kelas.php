...
if(isset($_POST['edit']))
{
	...
	//update ke tabel
	$query = "update kelas set kelas='$kelas',kode_kk='$kode_kk',kode_guru='$kode_guru',kelas_sk='$kelas_sk' where kode_kelas='$kode_kelas'";
	$sql = mysql_query ($query) or die (mysql_error());
	if ($sql) {
		echo "<script language=javascript>
alert('Data Kelas Berhasil Di Edit');
document.location='index.php?page=22';
</script>";	
			} else {
		echo "<script language=javascript>
alert('Data Kelas Gagal Di Edit');
document.location='index.php?page=22';
</script>";	
	}
}
...
<p>Kode Kelas</p>
<p><input type="text" class="form-control" name="kode_guru" size="25" value="<?php echo "$kode_kelas"; ?>" readonly required></p>
<p>Kelas</p>
<p><input type="text" class="form-control" name="kelas" size="25" value="<?php echo "$kelas"; ?>" required></p>
<p>Kode KK</p>
<p><input type="text" class="form-control" name="kode_kk" size="25" value="<?php echo "$kode_kk"; ?>" required></p>
<p>Kode Guru</p>
<p><input type="text" class="form-control" name="kode_guru" size="25" value="<?php echo "$kode_guru"; ?>" required></p>
<p>Kelas SK</p>
...
<a href="index.php?page=22"><input type="button"  class="btn btn-lg btn-default" value="Batal/Kembali"></a></p>
</form>
</div>
</div>
</div>
