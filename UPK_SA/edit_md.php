...
<?php
include "koneksi.php";
if(isset($_GET['kode_mata_diklat']))
{
...
if(isset($_POST['edit']))
{
	...
	//update ke tabel
	$query = "update mata_diklat set nama_mata_diklat='$nama_mata_diklat' where kode_kk='$kode_kk'";
	$sql = mysql_query ($query) or die (mysql_error());
	if ($sql) {
		echo "<script language=javascript>
alert('Data Mata Diklat Berhasil Di Edit');
document.location='index.php?page=10';
</script>";	
			} else {
		echo "<script language=javascript>
alert('Data Mata Diklat Gagal Di Edit');
document.location='index.php?page=10';
</script>";	
	}
}
...
<!-- Vendors -->
  ...
  <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">Edit Data Mata Diklat</h3>
            </div>
            <div class="panel-body">

    <form method="post" action="" enctype="multipart/form-data">
<p>Kode Mata Diklat</p>
<p><input type="text" class="form-control" name="kode_mata_diklat" size="25" value="<?php echo "$kode_mata_diklat"; ?>" readonly required></p>
<p>Nama Mata Diklat</p>
<p><input type="text" class="form-control" name="nama_mata_diklat" size="25" value="<?php echo "$nama_mata_diklat"; ?>" required></p>
<!--
<p>Gambar</p>
...
<a href="index.php?page=10"><input type="button"  class="btn btn-lg btn-default" value="Batal/Kembali"></a></p>
</form>
</div>
</div>
</div>
