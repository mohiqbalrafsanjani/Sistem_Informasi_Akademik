...
$data= mysql_fetch_row ($database);
	...
	//insert ke tabel
	$query = "insert into mata_diklat values('$kode_mata_diklat','$nama_mata_diklat')";
	$sql = mysql_query ($query) or die (mysql_error());
	if ($sql) {
		echo "<script language=javascript>
alert('Data Mata Diklat Berhasil Di Simpan');
document.location='index.php?page=9';
</script>";	
			} else {
		echo "<script language=javascript>
alert('Data Mata Diklat Gagal Di Simpan');
document.location='index.php?page=9';
</script>";	
	}
}
...
<?php
include "koneksi.php";
$query="SELECT max(kode_mata_diklat) as maxkode FROM mata_diklat";
$hasil=mysql_query($query);
$data=mysql_fetch_array($hasil);
$kode_mata_diklat=$data['maxkode'];
$no=(int) substr($kode_mata_diklat, 3,3);
$no++;
$char="MD";
...
<!-- Vendors -->
  ...
  <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">Input Data Mata Diklat</h3>
            </div>
...
<p><input type="text" class="form-control" name="kode_mata_diklat" size="25" value="<?php echo"$id"; ?>" readonly="" required ></p>
<p>Nama Mata Diklat</p>
<p><input type="text" class="form-control" name="nama_mata_diklat" size="25" required></p>
<!--<p>Gambar</p>
